"""
URL configuration for mombo project.
...
from pregnancy.views import Home, Search, Content, SearchDetail, ContentDetail
...
urlpatterns = [
    ...
    path("content/details/", ContentDetail.as_view(), name="content_detail"),
